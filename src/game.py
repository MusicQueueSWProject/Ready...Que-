...
from src.config import (
    ...
    BG_DARK, PANEL_DARK, PANEL_LIGHT, TEXT_WHITE, TEXT_MUTED,
    COLOR_GOLD, COLOR_SELECTED, COLOR_PERFECT, COLOR_GOOD, COLOR_MISS,
    COLOR_NOTE_BODY, COLOR_NOTE_HIGHLIGHT, FONT_DEF,
    LANE_KEYS, LANE_X, LANE_WIDTH, GEAR_START_X, GEAR_WIDTH,
    JUDGE_LINE_Y, NOTE_SPEED,
)
from src.utils import draw_graded_rounded_rect
from src.button import Button
from src.particle import Particle
from src.note import Note
from src.note_manager import NoteQueueManager
...
class RhythmGame:
    ...
    def init_sync_calibration(self):
        ...
        self.calib_beats = [1200 + 500 * i for i in range(300)]
    ...
    def draw_game_elements(self, current_time, game_over, mouse_pos):
        ...
        if self.is_paused and not game_over:
            ...
            pause_overlay.fill((10, 10, 14, 200))
